    ...
    <>
      ...
      <footer className="bg-forest-900 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="inline-block">
                <span className="text-2xl font-bold tracking-tight">
                  ...
                  <span className="text-sage-300">Rx</span>
              ...
              <div className="mt-6 flex gap-3">
                <a
                  ...
                  aria-label="Twitter"
                  className="rounded-lg bg-forest-800 p-2 text-gray-300 transition-colors hover:bg-sage hover:text-white"
                >
                  <svg
                    width="18"
                    height="18"
          ...
          {/* Email Capture */}
          <div className="mt-16 rounded-2xl bg-forest-800 px-6 py-8 sm:px-10">
            <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
              ...
              >
                <input
                  ...
                  className="w-full min-w-0 rounded-full border border-forest-600 bg-forest-900 px-4 py-2.5 text-sm text-white placeholder-gray-400 outline-none transition-colors focus:border-sage focus:ring-2 focus:ring-sage/30 sm:w-64"
                />
                <button
                  type="submit"
                  className="whitespace-nowrap rounded-full bg-sage px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-sage-600"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="border-t border-forest-800">
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-4 py-6 sm:px-6 md:flex-row md:justify-between lg:px-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-400">
              {/* HIPAA Badge */}
              <span className="inline-flex items-center gap-1.5 rounded-full border border-forest-700 px-3 py-1">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
